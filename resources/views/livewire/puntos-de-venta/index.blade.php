                    ...
                    <tr wire:key="pdv-{{ $pdv->id }}" class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">
                            <button type="button" wire:click="toggleActive({{ $pdv->id }})"
                                    ...
                                    class="relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed {{ $pdv->activo ? 'bg-blue-600' : 'bg-gray-200' }}">
