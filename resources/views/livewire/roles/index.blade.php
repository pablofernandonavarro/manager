<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-sm text-gray-700">Administra los roles y sus permisos en el sistema</p>
        </div>
        <div class="mt-4 sm:mt-0">
            <a href="/roles/crear" wire:navigate
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div class="sm:col-span-2">
                <label for="search" class="block text-sm font-medium text-gray-700 mb-2">Buscar rol</label>
                <div class="relative">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase">Usuarios</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-gray-600 uppercase">Permisos</th>
                    ...
                    <tr class="hover:bg-gray-50 transition-colors duration-150">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 bg-gradient-to-br from-purple-400 to-purple-600 rounded-lg flex items-center justify-center shadow-md">
                                ...
                                <div class="ml-4">
                                    ...
                                    @if(in_array($role->name, ['admin', 'supervisor', 'cajero']))
                                        <span class="text-xs text-gray-500">Rol del sistema</span>
                                    @endif
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-700 ring-1 ring-blue-600/20">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                            <div class="flex items-center">
                                ...
                                {{ $role->created_at->timezone(config('app.display_timezone'))->format('d/m/Y') }}
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex items-center justify-end gap-2">
                                <a href="/roles/{{ $role->id }}/editar" wire:navigate
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-16 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 mb-1">No se encontraron roles</h3>
                                <p class="text-sm text-gray-500">Intenta ajustar los filtros o crea un nuevo rol</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
