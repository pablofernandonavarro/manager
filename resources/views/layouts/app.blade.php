    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
            ...
            <nav class="mt-6 px-4 space-y-2 pb-6">
                ...
                <a href="{{ route('remitos.configuracion') }}"
                   class="flex items-center px-4 py-3 rounded-lg transition-colors {{ request()->is('remitos/configuracion*') ? 'bg-blue-600 text-white' : 'text-gray-300 hover:bg-gray-800 hover:text-white' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
