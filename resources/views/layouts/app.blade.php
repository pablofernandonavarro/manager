            ...
            <nav class="mt-6 px-4 space-y-2 pb-6">
                ...
                <div x-data="{ configOpen: @js($configOpen) }">
                    ...
                    <div x-show="configOpen" @if(!$configOpen) style="display:none" @endif class="mt-2 ml-4 space-y-1">
                        ...
                        <a href="/sucursales" class="flex items-center px-4 py-2 rounded-lg transition-colors text-sm {{ request()->is('sucursales*') ? 'bg-blue-600 text-white' : 'text-gray-400 hover:bg-gray-800 hover:text-white' }}">
                            <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
